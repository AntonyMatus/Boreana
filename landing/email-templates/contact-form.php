...
if( ! empty( $_POST['email'] ) ) {
	...
	// Email Subject
	$subject = 'Nuevo mensaje de mi página web | DLUX';
...
<div align="center" style="line-height:10px"><img src="https://dlux-soluna.com/images/logos/navbar_negro.svg" style="display: block; height: auto; border: 0; width: 228px; max-width: 100%;" width="228"/></div>
</td>
</tr>
</table>
<table border="0" cellpadding="10" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#ffffff;font-size:15px;">© 2021 DLUX. All rights reserved.</span></p>
</div>
</div>
</td>
</tr>
